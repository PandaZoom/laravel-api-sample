...
return [
    ...
    */
    ...
    'model_locations' => [
        'app',
        'packages/panda-zoom/laravel-language/src/Models',
        'packages/panda-zoom/laravel-language-log/src/Models',
        'packages/panda-zoom/laravel-passport/src/Models',
        'packages/panda-zoom/laravel-user/src/Models',
        'packages/panda-zoom/laravel-user-locale/src/Models',
        'packages/panda-zoom/laravel-user-log/src/Models',
        'packages/panda-zoom/laravel-user-timezone/src/Models',
        'packages/panda-zoom/laravel-status/src/Models',
        'packages/panda-zoom/laravel-article/src/Models',
        'packages/panda-zoom/laravel-article-log/src/Models',
        'packages/panda-zoom/laravel-category/src/Models',
        'packages/panda-zoom/laravel-comment/src/Models',
        'packages/panda-zoom/laravel-comment-log/src/Models',
    ],

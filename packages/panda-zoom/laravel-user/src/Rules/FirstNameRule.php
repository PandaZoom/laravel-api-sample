...
class FirstNameRule extends BaseCustomRule
{
    /**
    ...
    {
        if(config('common-api.rules.first_name.min')){
            $this->min = config('common-api.rules.first_name.min');
        }

        if(config('common-api.rules.first_name.max')){
            $this->max = config('common-api.rules.first_name.max');
        }
    }
